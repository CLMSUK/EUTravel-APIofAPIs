            ...
            set
            {
                ...
                if (value != null)
                {
                    if(entity != null && !Equals(entity, value))
                        entity.RemoveProperties(this);
                    entity = value;
                    entity.AddProperties(this);
                }
                else
                {
                    if(entity != null)
...
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            if (DataType != null && DataType.Length > 100)
            {
                __errors.Add("Length of property 'DataType' cannot be greater than 100.");
            }
            if (Entity == null)
            {
            ...
            {
                throw new BusinessException("An instance of TypeClass 'AuditPropertyConfiguration' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
