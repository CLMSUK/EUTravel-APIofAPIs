...
namespace EuTravel_2.BO
{
    ...
    [Serializable]
    [DataContract]
    public class from : IDomainModelClass
    {
        #region from's Fields
        ...
        [DataMember(Name="fromKey")]
        protected Guid? _fromKey = Guid.Empty;
        #endregion
        #region from's Properties
/// <summary>
/// The lat property
///
/// </summary>
...
/// <summary>
/// The fromKey property
///
/// </summary>
///
        [Key]
        public virtual Guid? fromKey
        {
            get
            {
                return _fromKey;
        ...
        #endregion
        #region from's Participant Properties
        [DataMember(Name="stopId")]
        protected stopId _stopId;
        public virtual stopId stopId
        {
            get
            {
                return _stopId;
        ...
        #region Constructors
/// <summary>
/// Public constructors of the from class
/// </summary>
/// <returns>New from object</returns>
/// <remarks></remarks>
        public from()
        {
            if (fromKey == null) fromKey = Guid.NewGuid();
        }
        #endregion
        #region Methods
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new BusinessException("An instance of TypeClass 'from' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <returns>A copy of the object</returns>
        ...
        public virtual PropertyInfo GetPrimaryKey()
        {
            ...
            {
                __propertyKeyCache = this.GetType().GetProperty("fromKey");
            }
        ...
        public override int GetHashCode()
        {
            ...
            else
            {
                unchecked
                {
                    ...
                    this.cachedHashcode = (hashCode * HashMultiplier) ^ this.fromKey.GetHashCode();
                }
            }
            return this.cachedHashcode.Value;
        }
...
/// </summary>
        ...
        {
            return this.fromKey == default(Guid) || this.fromKey.Equals(default(Guid));
        }
