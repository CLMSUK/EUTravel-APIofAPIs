...
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            if (ActiveRoles != null && ActiveRoles.Length > 2147483647)
            {
                __errors.Add("Length of property 'ActiveRoles' cannot be greater than 2147483647.");
            }
            if (ActivePermissions != null && ActivePermissions.Length > 2147483647)
            {
                __errors.Add("Length of property 'ActivePermissions' cannot be greater than 2147483647.");
            }
            ...
            if (ErrorMessage != null && ErrorMessage.Length > 2147483647)
            {
                __errors.Add("Length of property 'ErrorMessage' cannot be greater than 2147483647.");
            }
