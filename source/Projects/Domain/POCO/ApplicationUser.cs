...
///
        ...
        {
            if (__item != null && permissions!=null && !permissions.Contains(__item))
            {
        ...
        {
            if (__item != null && roles!=null && !roles.Contains(__item))
            {
                roles.Add(__item);
                if (!__item.Users.Contains(this))
                    __item.AddUsers(this);
        ...
        {
            if (__item != null && clients!=null && !clients.Contains(__item))
            {
                clients.Add(__item);
                if (__item.User != this)
                    __item.User = this;
        ...
        {
            if (__item != null && logins!=null && !logins.Contains(__item))
            {
                logins.Add(__item);
                if (__item.User != this)
                    __item.User = this;
        ...
        {
            if (__item != null && claims!=null && !claims.Contains(__item))
            {
                claims.Add(__item);
                if (__item.User != this)
                    __item.User = this;
...
/// </summary>
        ...
        {
            return this.UserName == default(string) || this.UserName.Equals(default(string));
        }
