...
///
        ...
        #endregion
        #region Payment's Participant Properties
            ...
            set
            {
                ...
                if (value != null)
                {
                    if(formOfPayment != null && !Equals(formOfPayment, value))
                        formOfPayment.Payment = null;
                    formOfPayment = value;
                    if(formOfPayment.Payment != this)
                        formOfPayment.Payment = this;
                }
                else
                {
...
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new BusinessException("An instance of TypeClass 'Payment' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
