...
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            if (Surname != null && Surname.Length > 2147483647)
            {
                __errors.Add("Length of property 'Surname' cannot be greater than 2147483647.");
            }
            if (DisplayName != null && DisplayName.Length > 2147483647)
            {
                __errors.Add("Length of property 'DisplayName' cannot be greater than 2147483647.");
            }
            if (Email != null && Email.Length > 2147483647)
            {
                __errors.Add("Length of property 'Email' cannot be greater than 2147483647.");
            }
            if (Provider != null && Provider.Length > 2147483647)
            {
                __errors.Add("Length of property 'Provider' cannot be greater than 2147483647.");
            }
