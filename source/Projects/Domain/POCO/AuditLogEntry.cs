...
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            if (EntityFullName != null && EntityFullName.Length > 100)
            {
                __errors.Add("Length of property 'EntityFullName' cannot be greater than 100.");
            }
            if (EntityShortName != null && EntityShortName.Length > 100)
            {
                __errors.Add("Length of property 'EntityShortName' cannot be greater than 100.");
            }
            if (EntityId != null && EntityId.Length > 100)
            {
                __errors.Add("Length of property 'EntityId' cannot be greater than 100.");
            }
            if (OldValue != null && OldValue.Length > 2147483647)
            {
                __errors.Add("Length of property 'OldValue' cannot be greater than 2147483647.");
            }
            if (NewValue != null && NewValue.Length > 2147483647)
            {
                __errors.Add("Length of property 'NewValue' cannot be greater than 2147483647.");
            }
            if (PropertyName != null && PropertyName.Length > 100)
            {
                __errors.Add("Length of property 'PropertyName' cannot be greater than 100.");
            }
